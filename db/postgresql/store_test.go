...
func TestTransferTx(t *testing.T) {
	...
	for i := 0; i < n; i++ {
		...
		// get the updated account balance for account 1
		fromAccount := result.FromAccount
		require.NotEmpty(t, fromAccount)
		require.Equal(t, account1.ID, fromAccount.ID)

		// get the updated account balance for account 2
...
func TestTransferTXDeadlock(t *testing.T) {
	...
	for i := 0; i < n; i++ {
		...
		// No need to check results since we already did in TestTransferTx
	}
